...
<section class="wrapper max-md:overflow-x-clip relative z-10">
	<div class="pb-5 max-md:mt-12 md:flex justify-between items-center md:min-h-[35rem] xl:min-h-[75vh]">
		<div class="text">
			<h1 class="text-nowrap max-md:w-fit max-md:mx-auto max-md:text-center font-semibold my-5 text-600 lg:text-700 relative isolate">
				Turn ideas into <span class="text-primary-300">reality</span>
				<img class="gear md:hidden absolute -top-10 -right-10" src="home/landingPage/Gear.svg" alt="" />
				<img class="play md:hidden absolute -top-20 -left-8" src="home/landingPage/play.svg" alt="" />
			</h1>
...
<style>
	...
	.play {
		animation: float 2.5s 0.5s infinite alternate ease-in-out;
	}
	.tags {
		animation: float 2.5s 0.25s infinite alternate ease-in-out;
	}
