<script>
	...
	let exploreDropDownContent = [
		{
			path: '/freelancer',
			value: 'Freelancer'
		},
		{
			path: '/client/createGig',
			value: 'Client'
		},
		{
			path: '/',
		...
		<div class="flex">
			<nav navbarVisibility="false">
				<ul class="font-semibold bg-off-white">
					<li>
						<button class="max-md:border-t-2 max-md:focus:text-primary-300 max-md:w-full p-[0.5em] focus-visible:ring-2 ring-black rounded-sm">
